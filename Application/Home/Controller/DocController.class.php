...
// | WeiPHP
// +----------------------------------------------------------------------
// | Copyright (c) 2013 https://www.weiphp.cn All rights reserved.
// +----------------------------------------------------------------------
...
class DocController extends HomeController {
	...
	public function detail($id = 0, $page = 1) {
		...
		if (! $info) {
			$this->error ( '110083:'.$Document->getError () );
		}
