...
class CreditConfigController extends HomeController {
	...
	public function lists() {
		...
		$list_data ['list_data']= $this->parseData ( $list_data ['list_data'], $dataTable->fields, $dataTable->list_grid, $dataTable->config );
	...
	public function edit() {
		...
		if (IS_POST) {
			...
			if ($res !== false ) {
				...
				// dump($Model->getLastSql());
				$this->error ( '110066:' . $Model->getError () );
			}
		} else {
