        ...
        if(IS_POST){
            ...
            if($data){
                ...
                if($id){
                    ...
                    $this->error( '140095:新增失败');
                }
            } else {
                $this->error( '140096:' . $Channel->getError());
            }
        } else {
            $pid = I('get.pid', 0);
            //获取父导航
        ...
        if(IS_POST){
            ...
            if($data){
                if($Channel->save()){
                    ...
                    $this->error( '140097:编辑失败');
                }

            } else {
                $this->error( '140098:' . $Channel->getError());
            }
        } else {
            $info = array();
            /* 获取数据 */
    ...
    public function sort(){
        if(IS_GET){
            ...
            if($res !== false){
                ...
                $this->error( '140102:排序失败！');
            }
        }else{
            $this->error( '140103:非法请求！');
        }
    }
}
