        ...
        if(IS_POST){
			...
			if($data){
                ...
                if($id){
                    ...
                    $this->error( '140165:新增失败');
                }
            } else {
                $this->error( '140166:' . $Model->getError());
            }
        } else {
            ...
            if($data){
                if($Model->save()!== false){
                   $this->success('更新成功', U('lists'));
                    ...
                    $this->error( '140167:更新失败');
                }
            } else {
                $this->error( '140168:' . $Menu->getError());
            }
        } else {
            $info = array();
            /* 获取数据 */
